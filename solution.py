...
def validate(data):
    ...
    for record in data:
        # Kiểm tra giá > 0 và Category không rỗng
    ...
    # In ra báo cáo để lấy điểm phần Logging
...
def transform(data):
    ...
    # 2. Chuyển Category thành Title Case (electronics -> Electronics)
    df['category'] = df['category'].str.title()
    
    # 3. Thêm timestamp để giám sát thời điểm xử lý
